...
export class PatientRequestMoveFromOthersComponent {
  ...
  // ==========================================
  // Submissão / Movimentação de Outros
  // ==========================================
  /**
   * Dispara a requisição para movimentar a solicitação vinda da aba Outros
   */
  protected onSubmit(): void {
    ...
    this.costAssistanceService.movePatientRequestFromOthers(requestId)
      .pipe(
        finalize(() => {
