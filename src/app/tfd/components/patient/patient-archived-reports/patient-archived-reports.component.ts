...
@Component({
  selector: 'app-patient-archived-reports',
  standalone: true,
  imports: [
    CommonModule,
    MatDialogModule,
  ...
  templateUrl: './patient-archived-reports.component.html',
  styleUrl: './patient-archived-reports.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PatientArchivedReportsComponent implements OnInit {
  ...
  protected readonly reports = signal<PatientReport[]>([]);
