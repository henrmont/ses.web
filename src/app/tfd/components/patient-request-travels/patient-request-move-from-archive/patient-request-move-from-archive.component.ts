...
export class PatientRequestMoveFromArchiveComponent {
  ...
  // ==========================================
  /**
   * Dispara a requisição para desarquivar/movimentar a solicitação dentro do contexto de Viagens
   */
  protected onSubmit(): void {
    ...
    this.travelService.movePatientRequestFromArchive(requestId)
      .pipe(
        finalize(() => {
