...
export class MovePatientRequestFromFinishedComponent {
  ...
  private readonly dialogRef = inject(MatDialogRef<MovePatientRequestFromFinishedComponent>);
  ...
  protected onSubmit(): void {
    ...
    this.travelService.movePatientRequestFromFinished(requestId).subscribe({
      next: (response: any) => {
