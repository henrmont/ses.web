...
export class ArchivePatientRequestOpinionsPage implements OnInit {
  ...
  protected movePatientRequestFromArchive(patientRequest: PatientRequest): void {
    this.openDialog(PatientRequestMoveFromArchiveComponent, { patient_request: patientRequest, type: this.profileType() }, '400px');
  }
