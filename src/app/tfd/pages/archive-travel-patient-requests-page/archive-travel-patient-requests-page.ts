...
import { MovePatientRequestFromArchiveComponent } from '../../components/travel/move-patient-request-from-archive-component/move-patient-request-from-archive-component';

const TFD_TRAVELS_CHANNEL = new BroadcastChannel('tfd-travels-channel');

@Component({
  selector: 'app-archive-travel-patient-requests-page',
  standalone: true,
  imports: [
    CommonModule,
    MatFormFieldModule, 
  ...
  templateUrl: './archive-travel-patient-requests-page.html',
  styleUrl: './archive-travel-patient-requests-page.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ArchiveTravelPatientRequestsPage implements OnInit {
