...
@Component({
  selector: 'app-archive-payment-patient-requests-page',
  standalone: true,
  imports: [
    CommonModule,
    MatFormFieldModule, 
  ...
  templateUrl: './archive-payment-patient-requests-page.html',
  styleUrl: './archive-payment-patient-requests-page.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class ArchivePaymentPatientRequestsPage implements OnInit {
  ...
  private fetchArchivePatientRequests(showLoading = false): void {
    ...
    this.paymentService.getArchivePatientRequests()
      .pipe(
        finalize(() => {
