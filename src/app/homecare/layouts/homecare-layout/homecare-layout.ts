...
const CHANNELS = {
  USERS: new BroadcastChannel('homecare-users-channel'),
  ROLES: new BroadcastChannel('homecare-roles-channel'),
  PATIENTS: new BroadcastChannel('homecare-patients-channel'),
};
